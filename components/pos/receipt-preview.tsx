...
export function ReceiptPreview({
  ...
  return (
    <PosCard
      ...
      action={
        <button className="flex items-center gap-2 rounded-lg border border-slate-800/80 bg-slate-900 px-3 py-1 text-xs font-medium text-slate-200 hover:border-slate-700 hover:text-white">
          <Printer className="h-3.5 w-3.5" />
          Print & kick drawer
        </button>
      }
    >
      <div className="space-y-4 rounded-xl border border-slate-800/80 bg-slate-950/60 p-4 text-xs text-slate-300">
        ...
        <div className="space-y-1 pt-2">
          ...
          <div className="flex items-center justify-between pt-1 text-sm font-semibold text-white">
            <span>Total</span>
        ...
        <div className="space-y-1 pt-2">
          {tenders.map((tender) => (
            <div key={tender.method} className="flex items-center justify-between text-slate-200">
        ...
        <div className="flex items-center justify-between rounded-lg border border-dashed border-slate-700/80 bg-slate-950/80 px-4 py-3 text-[11px] text-slate-400">
          <div>
            <p className="font-medium text-slate-200">Whatsapp send</p>
            <p>829-555-0101</p>
          </div>
